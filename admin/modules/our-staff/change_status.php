...
if (isset($_GET['change_status'])) {
  ...
  $query = "UPDATE tbl_department SET department_status='$status' WHERE department_id = '$id'";
...
if (isset($_GET['change_feature'])) {
  ...
  $query = "UPDATE tbl_department SET department_featured='$featured' WHERE department_id = '$id'";
  $chk = mysqli_query($link, $query);
  if ($chk) {
    $_SESSION['toast_type'] = "success";
