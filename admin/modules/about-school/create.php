...
<div class="main-container container-fluid">
    <div class="inner-body">
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">About School</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">About School</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><?= $ethos_id > 0 ? 'Update' : 'Add' ?> About School</h4>
                    </div>
                    <div class="card-body">
                        <div>
